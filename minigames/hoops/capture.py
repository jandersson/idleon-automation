...
BURST_FRAMES = 30
INTER_FRAME_DELAY = 0.1  # seconds — 30 frames x 0.1s = ~3s burst
STARTUP_DELAY = 3  # seconds before the burst starts
...
def run():
    ...
    print(f"Starting burst in {STARTUP_DELAY}s — bring the minigame into view now")
    ...
    print("Scrub through them, pick the clearest cue, crop it out, save as assets/indicator.png")
