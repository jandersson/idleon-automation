...
Run this when the dart-game-over screen is currently visible. Click two corners
around the stable on-screen text/element that identifies the end-of-game state.
Saves to assets/game_over.png so find_game_over can use it.
"""
import sys
import time
